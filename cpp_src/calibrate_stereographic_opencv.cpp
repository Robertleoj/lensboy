...
struct ReprojectionErrorStereographicOpenCV {
    ReprojectionErrorStereographicOpenCV(
    ...
    static ceres::CostFunction* create(
        ...
        return new ceres::AutoDiffCostFunction<
            ...
            3,
            5>(
            new ReprojectionErrorStereographicOpenCV(
                observed_x,
                observed_y,
                has_warp,
                warp_coords
    ...
    for (size_t camera_idx = 0; camera_idx < frames.size(); camera_idx++) {
        ...
        for (size_t observation_idx = 0; observation_idx < observations.size();
            ...
            problem.AddResidualBlock(
                ReprojectionErrorStereographicOpenCV::create(
                    observation(0, 0),
                    observation(1, 0),
                    has_warp,
                    warp_coords
